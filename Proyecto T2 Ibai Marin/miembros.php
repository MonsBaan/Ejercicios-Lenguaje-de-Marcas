...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="css/styleMiembros.css">
    ...
    <div id="menu">
      <ul>
        ...
        <li class="active"><a href="miembros.php" class="linkTitulo">Miembros</a></li>
    ...
    <div id="cuerpo">
      <ul>
        <div id="galeria">
          ...
          for ($j=0; $j < sizeOf($miembros); $j++) {
            echo "<h3>".$miembros[$j]['nombre']."</h3>";
            echo "<img class=imgGaleria src='".$miembros[$j]['imagen']."' alt='Imagen ".$miembros[$j]['nombre']."' class='portadaJuego'>";
            echo "<p>".$miembros[$j]['descripcion']."</p>";
            echo "<div class= 'floatclear'></div>";
            echo "<h4>".$miembros[$j]['Posicion']."</h4>";
          }
           ?>
        </div>
      </ul>
