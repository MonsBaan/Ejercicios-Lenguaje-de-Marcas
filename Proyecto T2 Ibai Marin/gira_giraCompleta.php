...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="css/styleGira_GiraCompleta.css">
    ...
    <div id="menu">
      <ul>
        ...
        <li><a href="gira_giraCompleta.php" class="linkTitulo">Gira</a>
          <ul>
            <li class="active"><a href="gira_giraCompleta.php" class="linkTitulo">Gira Completa</a></li>
    ...
    <div id="cuerpo">
      ...
      <?php
        $gira=getGiras();
        $cont = 0;
        for ($j=0; $j < sizeof($gira) ; $j++) {
          echo "<div id='FechasGira'>";
            echo "<h3 class='TituloGira'>".$gira[$j]['nombre']."</h3>";
