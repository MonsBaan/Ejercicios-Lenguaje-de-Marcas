...
<html lang="en" dir="ltr">
  <head>
    ...
    <div id="cuerpo">
      <form id="formulario" action="php/registrarUser.php" method="post">
        <label id="label" for="user">Usuario</label>
        <input id="txt" type="text" name="user" placeholder="Introduce tu usuario"><br>
        <label id="label" for="password">Contraseña</label>
        <input id="txt" type="password" name="password" placeholder="Introduce tu contraseña"><br>
        <label id="label" for="email">Email</label>
        <input id="txt" type="text" name="email" placeholder="Introduce tu email"><br>
