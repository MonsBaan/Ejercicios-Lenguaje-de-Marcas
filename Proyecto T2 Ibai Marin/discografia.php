...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="css/styleDiscografia.css">
  ...
  <body>
    <div id="menu">
      <ul>
        ...
        <li class="active"><a href="discografia.php" class="linkTitulo">Discografia</a></li>
      </ul>
      <?php
    ...
    <div id="cuerpo">
      <div class="ResumenMerchandising" id="seccion">
        ...
        for ($i=0; $i <= 9; $i++) {
          $merch=getMerch($i);
          for ($j=0; $j < sizeof($merch); $j++) {
            echo "<div id='album'>";
              echo "<img id= 'imagenAlbum' src='".$merch[$j]['imagen']."' alt='Mastodon ".$merch[$j]['nombre']."'>";
